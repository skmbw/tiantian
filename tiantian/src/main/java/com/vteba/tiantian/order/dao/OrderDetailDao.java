...
/**
 * 表order_detail的MyBatis Dao Mapper。
...
public interface OrderDetailDao {
     ...
     * @param params 查询条件
     */
    int count(OrderDetailBean params);

    /**
     * 根据params所携带条件进行计数，条件是等于，且是and关系。
     * @param params 查询条件
     */
    int countBy(OrderDetail params);

    /**
     * 根据params所携带条件删除记录，适用于复杂条件。
     * @param params 查询条件
     */
    int deleteBatch(OrderDetailBean params);

    /**
     * 根据params所携带条件删除数据，条件是等于，且是and关系。
     * @param params 删除条件
     */
    int deleteBulks(OrderDetail params);
     ...
     * @param params 查询条件
     */
    List<OrderDetail> queryForList(OrderDetailBean params);

    /**
     * 根据params所携带条件查询数据，条件是等于，且是and关系。
     * @param params 查询条件
     */
    List<OrderDetail> queryList(OrderDetail params);

    /**
     * 根据params所携带条件分页查询数据，适用于复杂查询。
     * @param params 查询条件
     */
    List<OrderDetail> pagedForList(OrderDetailBean params);

    /**
     * 根据params所携带条件分页查询数据，条件是等于，且是and关系。
     * @param params 查询条件
     */
    List<OrderDetail> pagedList(OrderDetail params);
     ...
     * @param params 查询条件
     */
    OrderDetail unique(OrderDetail params);
     ...
     */
    int updateBatch(@Param("record") OrderDetail record, @Param("params") OrderDetailBean params);
     ...
     * @param params update的where条件
     */
    int updateBulks(@Param("record") OrderDetail record, @Param("params") OrderDetail params);
